...
RUN zypper ar https://download.opensuse.org/repositories/home:/bastianfriedrich:/branches:/openSUSE:/Leap:/15.2:/Update/openSUSE_Leap_15.2 imap \
    && zypper install php7-imap:imap && zypper clean -a
